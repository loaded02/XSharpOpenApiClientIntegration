...
namespace Petstore.Client.Api
{
    ...
    public interface IPetApi : IApiAccessor
    {
        ...
        /// 
        /// </remarks>
        /// <exception cref="Petstore.Client.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        ApiResponse UploadFile (long petId, System.IO.Stream body = default(System.IO.Stream));
        ...
        ApiResponse<ApiResponse> UploadFileWithHttpInfo (long petId, System.IO.Stream body = default(System.IO.Stream));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse> UploadFileAsync (long petId, System.IO.Stream body = default(System.IO.Stream), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ApiResponse>> UploadFileWithHttpInfoAsync (long petId, System.IO.Stream body = default(System.IO.Stream), CancellationToken cancellationToken = default(CancellationToken));
    ...
    {
        private Petstore.Client.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = new Petstore.Client.Client.Configuration { BasePath = basePath };

            ExceptionFactory = Petstore.Client.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public PetApi()
        {
            this.Configuration = Petstore.Client.Client.Configuration.Default;
        ...
        /// <returns></returns>
        public PetApi(Petstore.Client.Client.Configuration configuration = null)
        {
        ...
        public Petstore.Client.Client.Configuration Configuration {get; set;}

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Petstore.Client.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse</returns>
        public ApiResponse UploadFile (long petId, System.IO.Stream body = default(System.IO.Stream))
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of ApiResponse</returns>
        public ApiResponse<ApiResponse> UploadFileWithHttpInfo (long petId, System.IO.Stream body = default(System.IO.Stream))
        {
            // verify the required parameter 'petId' is set
            if (petId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse> UploadFileAsync (long petId, System.IO.Stream body = default(System.IO.Stream), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<ApiResponse> localVarResponse = await UploadFileWithHttpInfoAsync(petId, body, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiResponse>> UploadFileWithHttpInfoAsync (long petId, System.IO.Stream body = default(System.IO.Stream), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'petId' is set
            if (petId == null)
                throw new ApiException(400, "Missing required parameter 'petId' when calling PetApi->UploadFile");
