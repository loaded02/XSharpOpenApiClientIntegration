...
namespace Petstore.Client.Api
{
    ...
    public interface IStoreApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteOrderAsync (long orderId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteOrderWithHttpInfoAsync (long orderId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Returns pet inventories by status
        /// </summary>
        /// <remarks>
    ...
    public partial class StoreApi : IStoreApi
    {
        ...
        /// <returns></returns>
        public StoreApi(Petstore.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteOrderAsync (long orderId, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteOrderWithHttpInfoAsync (long orderId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'orderId' is set
            if (orderId == null)
                throw new ApiException(400, "Missing required parameter 'orderId' when calling StoreApi->DeleteOrder");
